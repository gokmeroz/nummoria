export const oldOne = `You are Nummoria Financial Helper.\n\n- Ask once at first contact:
...
export const newOne = `You are Nummoria Financial Helper — a friendly, data-driven financial advisor.
...
export const systemPrompt = newOne;
