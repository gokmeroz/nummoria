...
export default function InvestmentPerformance() {
  ...
  const holdingsSorted = useMemo(() => {
    ...
    rows.sort((a, b) => {
      ...
      // Custom handling for different types/aliases
      if (
        sort.key === "valueMinor" ||
        sort.key === "plMinor" ||
        sort.key === "costMinor"
      ...
      // string-ish (symbol, currency, priceCurrency)
      const as = String(ak ?? "");
      const bs = String(bk ?? "");
        ...
        <section className="rounded-2xl border overflow-x-auto">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y">
              ...
              {!loading && holdingsSorted.length === 0 && (
                <tr>
