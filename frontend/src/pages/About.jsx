    ...
    <div className="min-h-screen w-full bg-white text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      <section className="relative overflow-hidden" style={gradients.hero}>
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20">
          ...
          transition-opacity duration-700 will-change-auto"
          >
            About Nummoria
          </h1>
          <p className="mt-5 max-w-2xl text-zinc-100/90 text-lg md:text-xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="/signup"
              className="inline-flex items-center gap-2 rounded-2xl bg-white/95 px-5 py-3 text-zinc-900 shadow hover:bg-white"
            >
              Get Started
            ...
            <a
              href="/docs"
              className="inline-flex items-center gap-2 rounded-2xl border border-white/60 bg-transparent px-5 py-3 text-white hover:bg-white/10"
            >
              Read the Docs
            </a>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6">
        <div className="-mt-10 grid grid-cols-2 gap-4 md:grid-cols-4">
          {[
            ...
            { label: "Tracked volume", value: "$50M+" },
      ...
      <section className="mx-auto max-w-6xl px-6 pb-8">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {[
            ...
            <div
              key={f.title}
              className="rounded-2xl border border-zinc-200/70 bg-white p-6 shadow-sm transition hover:shadow-md dark:border-zinc-800/70 dark:bg-zinc-900"
            >
              <div
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <ol className="relative mt-8 border-s border-zinc-200 dark:border-zinc-800">
          {[
            {
              when: "2024 → Idea",
            ...
            <li key={t.when} className="mb-10 ms-6">
              <span
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <h2 className="text-2xl md:text-3xl font-bold">How it’s built</h2>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        ...
        <div className="mt-6 divide-y divide-zinc-200 dark:divide-zinc-800 rounded-2xl border border-zinc-200/70 dark:border-zinc-800/70 overflow-hidden">
          {[
            {
              q: "Is Nummoria free?",
